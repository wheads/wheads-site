    ...
    return(
      <PageContainer>
        <TitleContainer >      
            ...
            <NetWorthDescription>When it comes to tracking your financial health, the best thermometer is your net worth.</NetWorthDescription>
        </TitleContainer>
        <CalcContainer>
          <AssetContainer>
            <ALContainer>
            ...
            <CategoryContainer>
              <CategoryIcon></CategoryIcon>
              <CategoryDesc style={{fontWeight: 'bold', color: '#146414', fontSize: '0.9rem'}}>TOTAL ASSETS</CategoryDesc>
              <CategoryAmount style={{borderTopColor: '#000000', borderTopStyle: 'double', textAlign: 'right', paddingRight: '10px', color: '#146414', fontWeight: 'bold', fontSize: '0.9rem'}}>
          ...
          <LiabilityContainer>
            ...
            <CategoryContainer>
              <CategoryIcon></CategoryIcon>
              <CategoryDesc style={{fontWeight: 'bold', color: 'red', fontSize: '0.9rem'}}>TOTAL LIABILITIES</CategoryDesc>
              <CategoryAmount style={{borderTopColor: '#000000', borderTopStyle: 'double', textAlign: 'right', paddingRight: '10px', color: 'red', fontWeight: 'bold', fontSize: '0.9rem'}}>
